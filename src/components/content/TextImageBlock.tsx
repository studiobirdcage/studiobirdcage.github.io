  ...
  return (
    <section className="flex flex-col-reverse px-6 py-12 min-[850px]:flex-row min-[850px]:px-30 min-[850px]:py-30">
      <div className="flex flex-1 flex-col justify-center">
        {title && (
          <h4 className="font-display-italic text-[28px] leading-[1.05] tracking-[-1px] text-[#121212] min-[850px]:text-[32px] min-[850px]:leading-none">
            {title}
          </h4>
        )}
      ...
      {image && (
        <div className="mb-8 flex flex-1 items-center justify-center min-[850px]:mb-0 min-[850px]:ml-30">
          <img
            className="w-full"
            src={image}
            alt={imageAltFromPath(image, title ?? "Project screenshot")}
            loading="lazy"
          />
        </div>
      )}
