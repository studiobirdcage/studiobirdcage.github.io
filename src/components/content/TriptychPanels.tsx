  ...
  return (
    <section className={`grid grid-cols-1 gap-5 bg-[#f9f8f9] px-6 py-12 min-[960px]:grid-cols-${arrayLength} min-[960px]:gap-0 min-[960px]:px-10 min-[960px]:py-30`}>
      {accessiblePanels.map((panel, index) => (
        <div
          className={`${arrayLength === 2 ? "px-16" : "px-0"} min-[960px]:flex min-[960px]:flex-col min-[960px]:justify-center min-[960px]:px-2.5 min-[960px]:first:pl-0 min-[960px]:last:pr-0 [&_img+img]:mt-2 [&_img+img]:min-[960px]:mt-7.5 [&_img]:w-full [&_img]:shadow-[0_0_20px_#808080] [&_img.no--shadow]:shadow-none`}
