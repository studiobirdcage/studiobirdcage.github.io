...
author: "Barrett Long"
tagline: "It's not the size of the website, but what you do with it... That comes out wrong."
...
After a whole lot longer than I originally planned, Studio Birdcage was finally live. Sort of. It was still very much in beta, but the important parts were there: I could show my work, write journal entries, and make updates without rebuilding the entire site every time I wanted to change a sentence. For a portfolio, that is a pretty good start.
